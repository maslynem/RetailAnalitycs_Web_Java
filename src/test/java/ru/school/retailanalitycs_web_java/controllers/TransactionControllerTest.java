...
class TransactionControllerTest extends IntegrationTestBase {
    ...
    void findTransactionsBy_page_1_size_2() throws Exception {
        TransactionDto first = TransactionDto.builder()
                .id(3)
                .customerCard(17)
                ...
                .build();
        TransactionDto second = TransactionDto.builder()
                .id(4)
                .customerCard(13)
        ...
        mockMvc.perform(get("/api/v1/transactions?page=1&size=2"))
                ...
                .andExpect(jsonPath("content[0].customerCard").value(first.getCustomerCard()))
                ...
                .andExpect(jsonPath("content[1].customerCard").value(second.getCustomerCard()))
    ...
    void findTransactionById() throws Exception {
        ...
        mockMvc.perform(get("/api/v1/transactions/{TRANSACTION_ID}", TRANSACTION_ID))
                ...
                .andExpect(jsonPath("$.customerCard").value(transactionDto.getCustomerCard()))
